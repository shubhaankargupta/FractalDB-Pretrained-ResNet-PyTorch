...
def conf():
	...
	parser.add_argument("--ft_dataset", default="imagenet", type = str, help="model name (fine-tuning dataset)")
	# paths
	parser.add_argument("--path2db", default="/content/imagenetimgs", type = str, help="path to fine-tuning dataset")
	...
	parser.add_argument("--numof_classes", default=1000, type = int, help="num of fine-tuning classes")
	...
	parser.add_argument("--log-interval", default=1, type=int, help="how many batches to wait before logging training status")
